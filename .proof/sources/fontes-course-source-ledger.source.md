...
The ledger currently covers 58 work-level source records:

- 49 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 6 source-identity rows that may only contribute source identity or gap status.
