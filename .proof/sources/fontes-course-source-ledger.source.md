...
The ledger currently covers 77 work-level source records:

- 63 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 11 source-identity rows that may only contribute source identity or gap status.
