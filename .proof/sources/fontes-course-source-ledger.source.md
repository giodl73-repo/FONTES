...
The ledger currently covers 88 work-level source records:

- 73 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 12 source-identity rows that may only contribute source identity or gap status.
