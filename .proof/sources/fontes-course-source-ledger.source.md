...
The ledger currently covers 157 work-level source records:

- 131 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 23 source-identity rows that may only contribute source identity or gap status.
