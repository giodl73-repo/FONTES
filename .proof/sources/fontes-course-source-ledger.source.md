...
The ledger currently covers 61 work-level source records:

- 51 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 7 source-identity rows that may only contribute source identity or gap status.
