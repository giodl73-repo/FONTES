...
The ledger currently covers 73 work-level source records:

- 60 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 10 source-identity rows that may only contribute source identity or gap status.
