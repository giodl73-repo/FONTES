...
The ledger currently covers 33 work-level source records:

- 28 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 2 source-identity rows that may only contribute source identity or gap status.
