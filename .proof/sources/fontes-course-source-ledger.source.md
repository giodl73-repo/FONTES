...
The ledger currently covers 55 work-level source records:

- 48 candidate rows ready for surface-level PEBBLE/CROP expansion.
- 4 source-identity rows that may only contribute source identity or gap status.
